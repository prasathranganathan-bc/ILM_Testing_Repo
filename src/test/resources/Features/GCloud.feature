Feature: G-Cloud13 - ILM UI Stories
  ...
  Examples:
  	| unam | pword |	
  	| gc1sand@yopmail.com | Demo@12345 |
  #2
  @GCloud
  Scenario: Supplier cannot able to make changes to the registered Company details of Registered Company Name
  ...
  #4
  @GCloud
  Scenario: Verify the Category admin cannot able to make changes to the registered Company details
  ...
  #5
  @GCloud
  Scenario: Verify the supplier can able to make changes to the registered Company details like company address trading status company size
  ...
  Scenario: Verify the supplier should not be able to see the opportunities link on the admin page
	...
	#7
   @GCloud
 	 Scenario: Verify the supplier can able to edit the Service line details for Cloud Support
